...
for k = 1:3
    ax = subplot(3,1,k);box on; hold on;
...
for k = 1:3
    ...
    % Xi error of each robot
    plot(t_data{k}, xi_data{k}, ...
        'LineWidth', LINE_WIDTH, ...
        'Color', COLORS(k,:), ...
        'MarkerSize', 4, ...
        'MarkerIndices', 5:30:length(t_data{k}), ...
        'DisplayName', LEGEND_XI{k});

    ylabel(['Robot ', num2str(k), ' Error'], ...
        'Interpreter','latex', ...
        'FontSize', FONT_SIZE, ...
        'FontName', FONT_NAME);
    ...
    % Legend inside the subplot
    lgd = legend('show');
    set(lgd, ...
        'Orientation','horizontal', ...
        'FontSize', FONT_SIZE-3, ...
        'FontName', FONT_NAME, ...
        'Location','northeast');  % place inside subplot
